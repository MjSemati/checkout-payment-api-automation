...
Body Status Error - Fail Fast On Non Success Body Status
    ...
    When User Requests Payment Methods With Scenario    body_error
...
Missing Title - Schema Validation Fails
    ...
    Given Checkout Payment API Is Available
    When User Requests Payment Methods With Scenario    missing_title
...
Empty Payment Methods Array
    ...
    Given Checkout Payment API Is Available
    When User Requests Payment Methods With Scenario    empty_payment_methods
...
Invalid Price Type - Rule R7 Violation
    ...
    Given Checkout Payment API Is Available
    When User Requests Payment Methods With Scenario    invalid_price_type
...
Clickable BNPL With Empty Options - Rule R4 Violation
    ...
    Given Checkout Payment API Is Available
    When User Requests Payment Methods With Scenario    clickable_bnpl_empty_options
